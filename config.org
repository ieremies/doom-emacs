...
#+end_src
** Grammar
I give up... just use VSCode when you are done...
* Completion
** corfu
...
#+end_src
*** FIXME In dirvish
When pressing ~alt~, it triggers ~dirvish-subtree-toggle~, the selection buffer does appear, the cursor previews on the background, but, after selecting and pressing ~RET~, nothing happens and the cursor comes
** buffer-terminator
...
# TODO: ff-find-other-file
** Python
*** TODO Ruff
I am not sure what is the problem here: either the global python eviroment or the lack of a .venv in each project...
#+begin_src elisp
;; (after! eglot
...
#+begin_src emacs-lisp :tangle yes
(after! eglot
  ;; https://www.reddit.com/r/emacs/comments/1n3o2we/on_macos_in_gui_with_eglot_turned_on_when_the/
...
(after! gptel
 ...
 gptel-backend (gptel-make-gemini "Gemini"
                 :key "AIzaSyDot20eqbyTPLERaDUEz2Xg4zKqvnPBlLQ"
                 :stream t))
  )
#+end_src
...
Another option is codeium, which is more private (and faster?).
